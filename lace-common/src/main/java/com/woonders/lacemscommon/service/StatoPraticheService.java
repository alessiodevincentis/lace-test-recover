...
public interface StatoPraticheService extends AppService {
     ...
     * return the number of procedures with specific status (stato pratica)
     */
    long countByStatoPraticaAndTipoClienteAndUsernameAndOperators(Long currentAziendaId, long currentOperatorId,
                                                      Role.RoleName clientiReadRoleName, String statoPratica,
                                                      String tipoPratica, List<String> operators);
     ...
     * return number of settled procedure by their status
     */
    long countEstinzioniByStatoConteggioEstinzioneAndTipoClienteAndUsernameAndOperators(Long currentAziendaId,
                                                                            long currentOperatorId, Role.RoleName clientiReadRoleName,
