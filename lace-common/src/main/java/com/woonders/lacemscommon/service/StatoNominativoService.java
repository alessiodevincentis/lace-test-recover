...
public interface StatoNominativoService {
     ...
     * return the number of leads by a specific status
     */
    long countNominativiByStatoNominativoAndOperators(Long currentAziendaId, long currentOperatorId,
                                          Role.RoleName nominativiReadRoleName, String statoNominativo, List<String> operators);
     ...
     * return a paged list of leads details by a specific status
     */
    ViewModelPage<ClienteViewModel> getNominativiByStatoNominativoAndOperators(Long currentAziendaId, long currentOperatorId,
                                                                   Role.RoleName nominativiReadRoleName, String statoNominativo, List<String> operators,
