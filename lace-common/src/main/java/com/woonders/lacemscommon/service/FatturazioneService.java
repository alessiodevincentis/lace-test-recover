...
public interface FatturazioneService {
     ...
     */
    void perfezionaPratiche(final String provenienza, final String provenienzaDesc, final Date dataInizio, final Date dataFine, final boolean liquidata,
     ...
     */
    ViewModelPage<ClientePratica> searchPratichePerfezionate(String provenienza, final String provenienzaDesc, Date dataInizio, Date dataFine, String username,
    ...
    ViewModelPage<ClientePratica> searchPraticheDaPerfezionare(String provenienza, final String provenienzaDesc, Date dataInizio, Date dataFine,
     ...
     */
    BigDecimal sumTotaleMontantePraticheDaPerfezionare(final String provenienza, final String provenienzaDesc, final Date dataInizio, final Date dataFine,
     ...
     */
    BigDecimal sumTotaleProvvigionePraticheDaPerfezionare(final String provenienza, final String provenienzaDesc, final Date dataInizio, final Date dataFine,
                                                          final boolean liquidata, final boolean liquidazione, final boolean quietanzata,
                                                          boolean perfeziomanentoSelected, Long currentAziendaId, Role.RoleName fatturazioneWriteRoleName);
     ...
     */
    BigDecimal sumTotaleProvvigionePratichePerfezionate(final String provenienza, final String provenienzaDesc, Date dataInizio, Date dataFine, String username,
     ...
     */
    BigDecimal sumTotaleMontantePratichePerfezionate(final String provenienza, final String provenienzaDesc, Date dataInizio, Date dataFine, String username,
                                                     Long currentAziendaId, long operatorId, long aziendaId, Role.RoleName fatturazioneReadRoleName);
