...
public class PredicateHelper {
    ...
    public BooleanExpression getPredicateForFindPraticheDaPerfezionare(Date dataInizio, Date dataFine,
    ...
    public BooleanExpression getPredicateForFindPratichePerfezionate(Date dataInizio, Date dataFine,
